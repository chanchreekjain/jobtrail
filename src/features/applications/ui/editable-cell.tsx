  ...
  return (
    <div>
      <input
        ...
        className={`w-full min-w-28 rounded-[var(--radius)] border bg-transparent px-2 py-1 disabled:opacity-50 ${error ? "border-negative" : "hover:border-line-strong focus:border-line-strong border-transparent"}`}
      />
